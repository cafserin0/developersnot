...
import { idlFactory } from './developersnot.did.js';
export { idlFactory } from './developersnot.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DEVELOPERSNOT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./developersnot.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the developersnot canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./developersnot.did.js")._SERVICE>}
 */
export const developersnot = createActor(canisterId);
